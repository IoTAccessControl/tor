...
#define CIRCPAD_COMMAND_POS_FIRST 0
#define CIRCPAD_COMMAND_STOP 1
#define CIRCPAD_COMMAND_START 2
#define CIRCPAD_COMMAND_EWFD_START 3
#define CIRCPAD_COMMAND_EWFD_DATA 4
#define CIRCPAD_COMMAND_EWFD_STOP 5
#define CIRCPAD_COMMAND_EWFD_STATE 6
#define CIRCPAD_COMMAND_EWFD_LAST 7
#define CIRCPAD_COMMAND_POS_LAST 8
